    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator(message='Slug может содержать только латинские буквы, цифры, дефисы и подчеркивания', regex='^[-a-zA-Z0-9_]+$')], verbose_name='слаг категории')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True, validators=[django.core.validators.RegexValidator(message='Slug может содержать только латинские буквы, цифры, дефисы и подчеркивания', regex='^[-a-zA-Z0-9_]+$')], verbose_name='слаг жанра')),
            ],
            options={
                'verbose_name': 'Жанр',
